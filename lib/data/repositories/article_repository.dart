import 'package:freezed_tutorial/data/api.dart';
import 'package:freezed_tutorial/data/models/data_list.dart';
...
class ArticleRepository {
  ...
  Future<Article?> fetch(int id) async {
    try {
      ...
      if (model != null) {
        _cache = DataList<Article>.fromIterable(<Article>[..._cache, model]);
        return model;
      }
